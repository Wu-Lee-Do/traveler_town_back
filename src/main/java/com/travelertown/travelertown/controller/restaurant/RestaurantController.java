...
//    }
    ...
    public ResponseEntity<?> updateRestaurantBoard(@PathVariable int boardId, @RequestBody UpdateBoardReqDto updateBoardReqDto) {
        return ResponseEntity.ok(restaurantService.updateRestaurantBoard(updateBoardReqDto));
    }
